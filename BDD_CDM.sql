...
CALL ajouter_equipe('A','Mexique','MX',11,'CONCACAF','El Tri',0,'Javier Aguirre');
CALL ajouter_equipe('A','Afrique du Sud','ZA',61,'CAF','Bafana Bafana',0,'Hugo Broos');
CALL ajouter_equipe('A','Corée du Sud','KR',23,'AFC','Taegeuk Warriors',0,'Hong Myung-bo');
CALL ajouter_equipe('A','Tchéquie','CZ',44,'UEFA','',0,'Miroslav Koubek');
CALL ajouter_equipe('B','Canada','CA',27,'CONCACAF','Les Rouges',0,'Jesse Marsch');
CALL ajouter_equipe('B','Qatar','QA',57,'AFC','Al-Annabi',0,'Julen Lopetegui');
CALL ajouter_equipe('B','Suisse','CH',19,'UEFA','La Nati',0,'Murat Yakin');
CALL ajouter_equipe('B','Bosnie-Herzégovine','BA',64,'UEFA','Les Dragons',0,'Sergej Barbarez');
CALL ajouter_equipe('C','Brésil','BR',5,'CONMEBOL','Seleção',5,'Carlo Ancelotti');
CALL ajouter_equipe('C','Maroc','MA',6,'CAF','Lions de l’Atlas',0,'Mohamed Ouahbi');
CALL ajouter_equipe('C','Écosse','gb-sct',41,'UEFA','Tartan Army',0,'Steve Clarke');
CALL ajouter_equipe('C','Haïti','HT',87,'CONCACAF','Grenadiers',0,'Sébastien Migné');
CALL ajouter_equipe('D','États-Unis','US',13,'CONCACAF','Team USA',0,'Mauricio Pochettino');
CALL ajouter_equipe('D','Paraguay','PY',37,'CONMEBOL','La Albirroja',0,'Gustavo Alfaro');
CALL ajouter_equipe('D','Australie','AU',25,'AFC','Socceroos',0,'Tony Popovic');
CALL ajouter_equipe('D','Türkiye','TR',32,'UEFA','Ay-Yıldızlılar',0,'Vincenzo Montella');
CALL ajouter_equipe('E','Allemagne','DE',8,'UEFA','Die Mannschaft',4,'Julian Nagelsmann');
CALL ajouter_equipe('E','Côte d’Ivoire','CI',31,'CAF','Les Éléphants',0,'Emerse Faé');
CALL ajouter_equipe('E','Équateur','EC',30,'CONMEBOL','La Tri',0,'Sebastián Beccacece');
CALL ajouter_equipe('E','Curaçao','CW',81,'CONCACAF','',0,'Dick Advocaat');
CALL ajouter_equipe('F','Suède','SE',36,'UEFA','Blågult',0,'Graham Potter');
CALL ajouter_equipe('F','Japon','JP',16,'AFC','Samurai Blue',0,'Hajime Moriyasu');
CALL ajouter_equipe('F','Pays-Bas','NL',7,'UEFA','Oranje',0,'Ronald Koeman');
CALL ajouter_equipe('F','Tunisie','TN',58,'CAF','Aigles de Carthage',0,'Hervé Renard');
CALL ajouter_equipe('G','Belgique','BE',10,'UEFA','Diables Rouges',0,'Rudi Garcia');
CALL ajouter_equipe('G','Iran','IR',22,'AFC','Team Melli',0,'Amir Ghalenoei');
CALL ajouter_equipe('G','Égypte','EG',28,'CAF','Les Pharaons',0,'Hossam Hassan');
CALL ajouter_equipe('G','Nouvelle-Zélande','NZ',83,'OFC','All Whites',0,'Darren Bazeley');
CALL ajouter_equipe('H','Espagne','ES',3,'UEFA','La Roja',1,'Luis de la Fuente');
CALL ajouter_equipe('H','Uruguay','UY',18,'CONMEBOL','La Celeste',2,'Marcelo Bielsa');
CALL ajouter_equipe('H','Arabie saoudite','SA',59,'AFC','Les Faucons Verts',0,'Georgios Donis');
CALL ajouter_equipe('H','Cap-Vert','CV',63,'CAF','Requins Bleus',0,'Bubista');
CALL ajouter_equipe('I','France','FR',2,'UEFA','Les Bleus',2,'Didier Deschamps');
CALL ajouter_equipe('I','Norvège','NO',26,'UEFA','Løvene',0,'Ståle Solbakken');
CALL ajouter_equipe('I','Sénégal','SN',17,'CAF','Lions de la Téranga',0,'Pape Thiaw');
CALL ajouter_equipe('I','Irak','IQ',60,'AFC','Lions de Mésopotamie',0,'Graham Arnold');
CALL ajouter_equipe('J','Argentine','AR',1,'CONMEBOL','Albiceleste',3,'Lionel Scaloni');
CALL ajouter_equipe('J','Autriche','AT',21,'UEFA','Das Team',0,'Ralf Rangnick');
CALL ajouter_equipe('J','Jordanie','JO',68,'AFC','Al-Nashama',0,'Jamal Sellami');
CALL ajouter_equipe('J','Algérie','DZ',29,'CAF','Les Fennecs',0,'Vladimir Petković');
CALL ajouter_equipe('K','Portugal','PT',9,'UEFA','A Seleção',0,'Roberto Martínez');
CALL ajouter_equipe('K','Colombie','CO',12,'CONMEBOL','Los Cafeteros',0,'Néstor Lorenzo');
CALL ajouter_equipe('K','RD Congo','CD',43,'CAF','Les Léopards',0,'Sébastien Desabre');
CALL ajouter_equipe('K','Ouzbékistan','UZ',54,'AFC','Loups Blancs',0,'Fabio Cannavaro');
CALL ajouter_equipe('L','Angleterre','gb-eng',4,'UEFA','Three Lions',1,'Thomas Tuchel');
CALL ajouter_equipe('L','Ghana','GH',65,'CAF','Black Stars',0,'Carlos Queiroz');
CALL ajouter_equipe('L','Panama','PA',40,'CONCACAF','Los Canaleros',0,'Thomas Christiansen');
CALL ajouter_equipe('L','Croatie','HR',15,'UEFA','Vatreni',0,'Zlatko Dalić');
